<?php    
    if(strpos($_SERVER['PHP_SELF'], "admin_utilities_log_email_details")){
	...
	if($logid != ""){
		...
		if($count > 0){
			...
			echo '<table align="center" border="1" width="650">';
				...
				echo '</tr>';
				echo '<tr>';
					echo '<td colspan="2">Body:<br><pre width="70">' . $row['emailBody'] . '</pre></td>';
				echo '</tr>	';
			echo '</table>';
			generatePageBreaks(4);
			echo generateButton('admin_utilities_log_email.php', "Back");
		}
		else {
